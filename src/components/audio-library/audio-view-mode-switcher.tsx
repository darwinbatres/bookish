...
import type { AudioViewMode } from "@/types";

interface AudioViewModeSwitcherProps {
  currentMode: AudioViewMode;
  onChange: (mode: AudioViewMode) => void;
}
...
export function AudioViewModeSwitcher({
  currentMode,
  onChange,
}: AudioViewModeSwitcherProps) {
  return (
